...
#set output "alpha_vs_Cm_Mandal.svg"
#set terminal pdfcairo enhanced color solid

set output "alpha_vs_Cm_Mandal.pdf"
...
plot 'reference_data.dat' using 5:3  with points pt 6 ps 1.5 lc rgb "black" title 'Exprement'\
    ,"forces/0/forceCoeffs.dat" every ::1 u (0.016 + 2.51 * sin(39.971 * $1)) : ($4) w l ls 3 title "dbns-second order" \
    , 'Mandal_cm.data' using 1:2  with points pt 7 ps 0.5 lc rgb "red" title 'Mandal'\
