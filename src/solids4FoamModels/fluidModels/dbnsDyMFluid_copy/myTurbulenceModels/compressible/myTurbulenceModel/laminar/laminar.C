...
addToRunTimeSelectionTable(myTurbulenceModel, laminar, myTurbulenceModel);
...
:
    myTurbulenceModel(rho, U, phi, thermophysicalModel, myTurbulenceModelName)
{}
...
)
{
    ...
    (
        new laminar(rho, U, phi, thermophysicalModel, myTurbulenceModelName)
    );
}
