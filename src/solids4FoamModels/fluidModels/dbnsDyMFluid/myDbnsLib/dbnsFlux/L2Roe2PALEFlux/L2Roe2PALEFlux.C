...
#include "L2Roe2PALEFlux.H"
#include "addToRunTimeSelectionTable.H"

namespace Foam
{
    defineTypeNameAndDebug(L2Roe2PALEFlux, 0);
    addToRunTimeSelectionTable(dbnsFlux, L2Roe2PALEFlux, dictionary);
}

// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

void Foam::L2Roe2PALEFlux::evaluateFlux
(
    scalar& rhoFlux,
    vector& rhoUFlux,
    scalar& rhoEFlux,
...
//     };
    ...
    const scalar zeta = 1- (1-zeta1) *fp ;
