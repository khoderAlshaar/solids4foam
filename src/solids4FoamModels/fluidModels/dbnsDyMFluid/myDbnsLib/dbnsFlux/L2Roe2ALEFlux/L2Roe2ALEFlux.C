...
#include "L2Roe2ALEFlux.H"
#include "addToRunTimeSelectionTable.H"

namespace Foam
{
    defineTypeNameAndDebug(L2Roe2ALEFlux, 0);
    addToRunTimeSelectionTable(dbnsFlux, L2Roe2ALEFlux, dictionary);
}

// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

void Foam::L2Roe2ALEFlux::evaluateFlux
(
    scalar& rhoFlux,
    vector& rhoUFlux,
    scalar& rhoEFlux,
