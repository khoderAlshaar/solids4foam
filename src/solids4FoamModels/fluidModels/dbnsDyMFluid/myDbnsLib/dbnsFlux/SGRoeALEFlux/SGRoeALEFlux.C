...
#include "SGRoeALEFlux.H"
#include "addToRunTimeSelectionTable.H"

namespace Foam
{
    defineTypeNameAndDebug(SGRoeALEFlux, 0);
    addToRunTimeSelectionTable(dbnsFlux, SGRoeALEFlux, dictionary);
}

void Foam::SGRoeALEFlux::evaluateFlux
(
    scalar& rhoFlux,
    vector& rhoUFlux,
    scalar& rhoEFlux,
