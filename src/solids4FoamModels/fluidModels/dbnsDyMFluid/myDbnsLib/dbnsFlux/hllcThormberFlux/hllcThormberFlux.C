...
#include "hllcThormberFlux.H"
#include "addToRunTimeSelectionTable.H"

namespace Foam
{
    defineTypeNameAndDebug(hllcThormberFlux, 0);
    addToRunTimeSelectionTable(dbnsFlux, hllcThormberFlux, dictionary);
}

// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

void Foam::hllcThormberFlux::evaluateFlux
(
    scalar& rhoFlux,
    vector& rhoUFlux,
    scalar& rhoEFlux,
...
void Foam::hllcThormberFlux::evaluateFlux_Wall
(
    scalar& rhoFlux,
    vector& rhoUFlux,
    scalar& rhoEFlux,
