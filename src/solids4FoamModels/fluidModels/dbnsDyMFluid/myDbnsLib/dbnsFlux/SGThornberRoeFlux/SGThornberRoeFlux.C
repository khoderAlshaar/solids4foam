...
namespace Foam
{
    defineTypeNameAndDebug(SGThornberRoeFlux, 0);
    addToRunTimeSelectionTable(dbnsFlux, SGThornberRoeFlux, dictionary);
}

void Foam::SGThornberRoeFlux::evaluateFlux
(
    scalar& rhoFlux,
    vector& rhoUFlux,
    scalar& rhoEFlux,
...
) const
{
    ...
    const scalar zeta_eff = 1; //! change later
