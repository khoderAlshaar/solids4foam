    ...
    curTimeIndex_(-1)
{
    ...
    )
    {
        FatalErrorIn
        (
            "explicitSolidTractionLinearMomentumFvPatchVectorField::explicitSolidTractionLinearMomentumFvPatchVectorField"
...
explicitSolidTractionLinearMomentumFvPatchVectorField
(
    const explicitSolidTractionLinearMomentumFvPatchVectorField& pvf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
void explicitSolidTractionLinearMomentumFvPatchVectorField::autoMap
(
...
void explicitSolidTractionLinearMomentumFvPatchVectorField::rmap
(
...
)
{
    ...
    const explicitSolidTractionLinearMomentumFvPatchVectorField& rpvf =
        refCast<const explicitSolidTractionLinearMomentumFvPatchVectorField>(pvf);
...
void explicitSolidTractionLinearMomentumFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void explicitSolidTractionLinearMomentumFvPatchVectorField::evaluate
(
...
void explicitSolidTractionLinearMomentumFvPatchVectorField::write(Ostream& os) const
{
...
makePatchTypeField(fvPatchVectorField, explicitSolidTractionLinearMomentumFvPatchVectorField);
